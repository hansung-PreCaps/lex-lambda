...
def dispatch(intent_request):
    ...
    situation = slots['Situation'] if 'Situation' in slots else None
    atmosphere = slots['Atmosphere'] if 'Atmosphere' in slots else None
    ...
    if (not isinstance(message_keyword, type(None))
            or not isinstance(message_purpose, type(None)))\
            or not isinstance(situation, type(None))\
            or not isinstance(atmosphere, type(None)):
